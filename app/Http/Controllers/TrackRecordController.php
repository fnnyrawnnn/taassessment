...
class TrackRecordController extends Controller
{
    ...
    public function trackTrainingDelete($id)
    {
        ...
        if ($track_training->status == "Menunggu"  || $track_training->status == "Ditolak") {
            ...
            return redirect('track-record')->with('status', 'Data pelatihan/sertifikasi berhasil dihapus!');
        } else {
            return redirect('track-record')->with('status', 'Maaf data pelatihan tersebut tidak bisa dihapus, karena status sudah berubah');
        }
    }
    ...
    public function trackProjectEditProcess($id, Request $request)
    {
        ...
        return redirect('track-record')->with('status', 'Data project berhasil diperbarui!');
    }
    ...
    public function trackProjectDelete($id)
    {
        ...
        if ($track_project->status == "Sedang Berlangsung") {
            ...
            return redirect('track-record')->with('status', 'Data project berhasil dihapus!');
        } else {
            return redirect('track-record')->with('status', 'Maaf data project tersebut tidak bisa dihapus, karena status sudah berubah');
        }
    }
