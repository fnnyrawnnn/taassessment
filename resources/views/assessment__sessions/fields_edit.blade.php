...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group col">
                ...
                {!! Form::text('name', $assessmentSession->name, ['class' => 'form-control', 'placeholder' => 'Assessment Session Name', 'id'=>'name']) !!}
            </div>
            <!-- Category Field -->
            <div class="form-group col">
                {!! Form::label('category', 'Category:') !!}
                {!! Form::select('category', ['development' => 'development', 'management' => 'management', 'project_manager' => 'project manager'], $assessmentSession->category, ['class' => 'form-control', 'placeholder' => 'Select Category']) !!}
            </div>
        </div>
        <!-- Status Field -->
        <div class="row">
            <div class="form-group col">
                ...
                {!! Form::select('status', ['open' => 'open', 'not_started' => 'not started', 'finished' => 'finished'], $assessmentSession->status, ['class' => 'form-control', 'placeholder' => 'Select Status']) !!}
            </div>
            <!-- Expired Field -->
            <div class="form-group col">
                {!! Form::label('expired', 'Expired:') !!}
                {!! Form::select('expired', ['one_year' => 'one year', 'six_month' => 'six month', 'three_month' => 'three month'], $assessmentSession->expired, ['class' => 'form-control', 'placeholder' => 'Select Expired']) !!}
            </div>
        </div>
        <div class="form-group">
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    {!! Form::date('start_date', $assessmentSession->start_date, ['class' => 'form-control','id'=>'start_date']) !!}
                </div>
                <!-- End Date Field -->
                <div class="col">
                    {!! Form::label('end_date', 'End Date:') !!}
                    {!! Form::date('end_date', $assessmentSession->end_date, ['class' => 'form-control','id'=>'end_date']) !!}
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#status").val(assessmentSession["status"]);
            ...
            $("#saveUpdateAll").on("click", function () {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href = '/assessmentSessions';
                        }
                    });
            });
        });
