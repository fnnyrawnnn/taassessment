    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div>
                ...
                <!-- Nav Item  -->
                <li class="nav-item @yield('JobTargets')">
            ...
            @endif
            @if(session('permission') == 'superadmin' || session('permission') == 'admin' || session('permission') == 'admin_ap' || session('permission') == 'user')
            <div>
                <!-- Divider -->
                <hr class="sidebar-divider">
                <!-- Heading -->
            ...
            @endif
            @if(session('permission') == 'superadmin' || session('permission') == 'admin' || session('permission') == 'admin_tnd' || session('permission') == 'user')
            <div>
                <!-- Divider -->
                <hr class="sidebar-divider">
                <!-- Heading -->
