    ...
    <div class="card-body">
        <form action="{{url('track-record/training-verification/'.$track_training->id)}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="training_name" id="training_name" class="form-control" value="{{ $track_training->name }}" disabled>
            </div>
            <div class="form-group">
                <label for="host">Nama Pelaksana</label>
                <input type="text" name="host" id="host" class="form-control" value="{{  $track_training->host }}" disabled>
            </div>
            <div class="form-group">
                <label for="duration">Durasi Pelatihan</label>
                <div class="row">
                    <div class="col-sm-2">
                        <input type="number" name="duration" id="duration" class="form-control" value="{{ $track_training->duration }}" disabled>
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="start_date" id="start_date" class="date form-control" value="{{ $track_training->start_date }}" disabled>
            </div>
            <div class="form-group">
                <label for="end_date">Tanggal Selesai</label>
                <input type="text" name="end_date" id="end_date" class="date form-control " value="{{ $track_training->end_date }}" disabled>
            </div>
            <div class="form-group">
                <label for="description">Deskripsi Pelatihan</label>
                <textarea name="description" class="form-control" rows="5" disabled>{{ $track_training->description }}</textarea>
            </div>
            <div class="row align-items-center">
                <div class="col">
                    <div class="form-group">
                        <label for="certificate">Bukti Sertifikat</label>
                        <input type="text" name="certificate" id="certificate" class="form-control" value="{{ $track_training->certificate }}" disabled>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="url" name="link" id="link" class="form-control" value="{{ $track_training->link }}" disabled>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label for="reason_associated_work">Keterkaitan Dengan Pekerjaan</label>
                <textarea name="reason_associated_work" class="form-control" rows="5" disabled>{{ $track_training->reason_associated_work }}</textarea>
            </div>
            ...
            <div class="form-group d-none" id="verificationDiv">
                ...
                <textarea name="reason_rejected" class="form-control @error('reason_rejected') is-invalid @enderror" rows="5" placeholder="Isikan Alasan Anda Mengapa Data ini Ditolak">{{ old('reason_rejected', $track_training->reason_rejected)}}</textarea>
