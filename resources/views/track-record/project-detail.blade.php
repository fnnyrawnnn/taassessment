...
<div class="card shadow mb-4">
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" name="project_name" id="project_name" class="form-control" value="{{ $track_project->name }}" disabled>
        </div>
        <div class="form-group">
            <label for="platform">Platform Output Project</label>
            <input type="text" name="platform" id="platform" class="form-control" value="{{  $track_project->platform }}" disabled>
        </div>
        <div class="form-group">
            <label for="position">Posisi Dalam Project</label>
            <input type="text" name="position" id="position" class="form-control" value="{{  $track_project->position }}" disabled>
        </div>
        <div class="form-group">
            <label for="status">Status Project</label>
            <input type="text" name="status" id="status" class="form-control" value="{{  $track_project->status }}" disabled>
        </div>
        <div class="form-group">
            <label for="start_date">Tanggal Mulai</label>
            <input type="text" name="start_date" id="start_date" class="date form-control" value="{{ $track_project->start_date }}" disabled>
        </div>

        @if ($track_project->status == "Selesai" || $track_project->status == "Gagal")
        <div class="form-group">
            <label for="end_date">Tanggal Selesai</label>
            <input type="text" name="end_date" id="end_date" class="date form-control " value="{{ $track_project->end_date }}" disabled>
        </div>
        @endif

        <div class="form-group">
            <label for="description">Deskripsi Project</label>
            <textarea name="description" class="form-control" rows="5" disabled>{{ $track_project->description }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="reason_failed" class="form-control" rows="5" disabled>{{ $track_project->reason_failed }}</textarea>
        </div>
